...
variable "environment" {
  type        = string
  default     = "dev"
  description = "ID element. Usually used for role 'prod', 'staging', 'dev', 'UAT'"
}
...
variable "security_groups" {
 ...
 # Configure environment for  Auto Scaling group.
...
variable "elb_stickiness_enabled" {
  type        = bool
  default     = false
  description = "Flag to enable or disable Stickey session."
}
variable "elb_stickiness_type" {
  type        = string
  default     = "lb_cookie"
  description = "Provide the type of stickey session."
}

variable "elb_stickiness_cookie_duration" {
  type        = string
  default     = "86400"
  description = "Provide the Stickiness Cookie Duration"
}
...
variable "updating_batch_type" {
  type        = string
  default     = "Percentage"
  description = ""
}

variable "updating_batch_size" {
  type        = number
  default     = 30
  description = ""
}
